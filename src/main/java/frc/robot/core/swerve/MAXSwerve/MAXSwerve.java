...
import frc.robot.core.swerve.MAXSwerve.MAXSwerveUtils;
...
public abstract class MAXSwerve extends SubsystemBase{
    ...
    private SlewRateLimiter m_rotLimiter = new SlewRateLimiter(MaxSwerveConstants.kRotationalSlewRate);
    ...
    public MAXSwerve(ADIS16470_IMU imu, MAXSwerveModule fl, MAXSwerveModule fr, MAXSwerveModule bl, MAXSwerveModule br)
    {
        this.gyro = imu;
        this.fl = fl;
        this.fr = fr;
      ...
      public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
        ...
        if (rateLimit) {
          ...
          if (m_currentTranslationMag != 0.0) {
            directionSlewRate = Math.abs(MaxSwerveConstants.kDirectionSlewRate / m_currentTranslationMag);
          } else {
          ...
          double angleDif = MAXSwerveUtils.AngleDifference(inputTranslationDir, m_currentTranslationDir);
          if (angleDif < 0.45*Math.PI) {
            m_currentTranslationDir = MAXSwerveUtils.StepTowardsCircular(m_currentTranslationDir, inputTranslationDir, directionSlewRate * elapsedTime);
